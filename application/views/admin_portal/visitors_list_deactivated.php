                ...
                if( isset($result) && !empty($result))
                {
                    ...
                    {   
                        ...
                        <tr>
                            ...
                            <td class="text-right">
                                <a href="<?php echo site_url('admin_portal/reactivate_visitor/'.$id); ?>" onclick="return confirm('Are you sure you want to reactivate this account?')" class="btn btn-xs btn-success">Reactivate</a>
                            </td>
                        </tr>
                        <?php
                    }
